...
function filterLocations() {
  ...
  function getLatLngViaHttpRequest(address) {
    ...
    var key = 'XXXXXXXXXXXXXXXXXXXX'; // REPLACE WITH YOUR GOOGLE MAPS API KEY
    ...
    $.get( request, function( data ) {
      ...
      if (filteredLocations.length > 0) {
        ...
        searchResultsAlert.innerHTML = 'Partner Locations within ' + maxRadius + ' miles of ' + userAddress + ':';
      } else {
        console.log("nothing found!");
        document.getElementById('locations-near-you').innerHTML = '';
        searchResultsAlert.innerHTML = 'Sorry, no partner locations were found within '+ maxRadius + ' miles of ' + userAddress + '.';
      }
